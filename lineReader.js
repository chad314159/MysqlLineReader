...
var connection = mysql.createConnection({
  host     : 'localhost',
  database : 'enter the name of your schema (assuming you are using MYSQL)'
});
...
lineReader.eachLine('jsonRecords.json', function(line, last) {
  execute = false;
...
//Change the query to align with your schema
    if (numRecords == recordBlock) {
      query = "INSERT INTO products (name, category, description, ASIN) VALUES ${values};"; //Template, replaces ${values} with the value of values.
      values = "";
      numRecords = 0;
      execute = true;
    }
